...
endpaint::endpaint(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::endpaint)
{
    ui->setupUi(this);
...
void endpaint::paintEvent(QPaintEvent *)
{
...
void endpaint::on_MenuButton_clicked()
{
    this->close();
...
void endpaint::on_Usability_QuestionnaireButton_clicked()
{
    this->close();
